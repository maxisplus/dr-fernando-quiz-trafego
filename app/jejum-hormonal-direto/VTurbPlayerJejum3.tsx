...
export function VTurbPlayerJejum3() {
  ...
  useEffect(() => {
    ...
    const embedHTML = '<vturb-smartplayer id="vid-693706a6fdeff6297583dee3" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>';
    ...
    const existingScript = document.querySelector('script[src*="693706a6fdeff6297583dee3"]');
    
    // Carregar o script do player
    if (!existingScript) {
      const playerScript = document.createElement('script');
      playerScript.type = 'text/javascript';
      playerScript.src = 'https://scripts.converteai.net/7884099c-a7d0-4d10-b5db-0f8165b855ab/players/693706a6fdeff6297583dee3/v4/player.js';
