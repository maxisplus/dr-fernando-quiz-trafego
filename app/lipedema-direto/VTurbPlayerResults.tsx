...
export function VTurbPlayerResults() {
  ...
  useEffect(() => {
    ...
    const embedHTML = '<vturb-smartplayer id="vid-6937062f2d43d777bf1bf533" style="display: block; margin: 0 auto; width: 100%; max-width: 400px;"></vturb-smartplayer>';
    ...
    const existingScript = document.querySelector('script[src*="6937062f2d43d777bf1bf533"]');
    
    // Carregar o script do player
    if (!existingScript) {
      const playerScript = document.createElement('script');
      playerScript.type = 'text/javascript';
      playerScript.src = 'https://scripts.converteai.net/7884099c-a7d0-4d10-b5db-0f8165b855ab/players/6937062f2d43d777bf1bf533/v4/player.js';
